...
# DNS only to the cache's real upstreams (blocks tunneling to an arbitrary nameserver). The
# entrypoint saved them to /run/sluice-dns-upstream; fall back to resolv.conf. Match IPv4 only.
